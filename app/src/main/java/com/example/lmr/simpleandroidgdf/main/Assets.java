...
import com.example.lmr.simpleandroidgdf.animation.Animation;
import com.example.lmr.simpleandroidgdf.animation.Frame;
...
public class Assets {
    ...
    public static Bitmap welcome,block,cloud1,cloud2,duck,grass,jump,run1,run2,run3,run4,run5,scoreDown,
