...
import com.example.lmr.simpleandroidgdf.model.Block;
import com.example.lmr.simpleandroidgdf.model.Cloud;
import com.example.lmr.simpleandroidgdf.model.Player;
...
public class PlayState extends State {
    ...
    public void render(Painter painter) {
        ...
        renderSun(painter);
        renderClouds(painter);
        painter.drawImage(Assets.grass,0,405);
        renderScore(painter);
    }
